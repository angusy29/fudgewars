...
export default class Boot extends Phaser.State {
    public preload(): void {
        ...
        // this.game.load.atlasJSONHash(Assets.Atlases.AtlasesP2Walk.getName(), Assets.Atlases.AtlasesP2Walk.getPNG(), Assets.Atlases.AtlasesP2Walk.getJSON());
    }

    public create(): void {
        // Do anything here that you need to be setup immediately, before the game actually starts doing anything.

        // Comment the following to disable multitouch
